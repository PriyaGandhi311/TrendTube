package com.trendtube.processing_video_service.entity;
...
public class Video {
    ...
    @Column(length = 5000)
    @Schema(description = "Full description of the video", example = "This video covers Java basics and syntax...")
